<div>
    <x-wire-card>
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Importar Categorías de Gasto desde Excel</h1>
        <p class="text-sm text-gray-500 mb-4">Columnas requeridas: name</p>
        ...
        <div class="mt-4">
            <x-wire-button green wire:click="importExpenseCategories" wire:loading.attr="disabled" wire:target="file" spinner="importExpenseCategories">
            ...
            <div class="mt-4">
                <div class="p-4 bg-yellow-100 border border-yellow-300 rounded-md text-yellow-800 mb-3">
                    @if ($importedCount)
                        ...
                        <p class="mt-1 text-sm">Algunas categorías fallaron.</p>
                    @else
