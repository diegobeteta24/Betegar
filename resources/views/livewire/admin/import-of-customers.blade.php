<div>
    <x-wire-card>
        ...
        <div class="mt-4">
            <x-wire-button green wire:click="importCustomers" wire:loading.attr="disabled" wire:target="file" spinner="importCustomers">
            ...
            <div class="mt-4">
                <div class="p-4 bg-yellow-100 border border-yellow-300 rounded-md text-yellow-800 mb-3">
                    @if ($importedCount)
                        ...
                        <p class="mt-1 text-sm">Algunos clientes no se pudieron importar debido a errores</p>
                    @else
                        <i class="fas fa-xmark-circle mr-2"></i>
                        <strong>No se importó ningún cliente</strong>
                        <p class="mt-1 text-sm">Todos los clientes tienen errores y no se pudieron importar.</p>
                    @endif
                </div>
                <ul class="space-y-2">
