        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="grid lg:grid-cols-4 gap-4">
               ...
               <div class="grid lg:grid-cols-2 gap-4">
                ...
                <x-wire-select  label="Almacen de origen" wire:model.live="origin_warehouse_id"
                    ...
                    :disabled="count($products)" />
                     ...
                     <x-wire-select  label="Almacen de destino" wire:model="destination_warehouse_id"
                    placeholder="Seleccione un almacén" :async-data="[
                        'api' => route('api.warehouses.index'),
                        'method' => 'POST',
                        'params' => [
                            'exclude' => $this->origin_warehouse_id // Exclude the origin warehouse
                        ],
                    ]" option-label="name" option-value="id"
                    option-description="description" />
            ...
            <div class="lg:flex lg:space-x-4">
                ...
                <x-wire-select label="Productos" wire:model="product_id" placeholder="Seleccione un producto"
                    :async-data="[
                    ...
                    <tbody>
                        ...
                        <template x-for="(product, index) in products" :key="product.id">
                            <tr class="border-b">
                                ...
                                <td class="py-1 px-4">
                                    <x-wire-input type="number" x-model="product.price" class="w-20"
                                        step="0.01" />
                                </td>
                                <td class="py-1 px-4" x-text="(product.quantity * product.price).toFixed(2)">
                                </td>
                                <td class="py-1 px-4">
