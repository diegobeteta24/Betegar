    ...
    <x-wire-card>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="grid lg:grid-cols-4 gap-4">
                ...
                <x-wire-native-select label="Tipo de Documento" wire:model.live="type">
                ...
                <x-wire-select class="lg:col-span-2" label="Razones" wire:model="reason_id"
                    placeholder="Seleccione una razón" :async-data="[
