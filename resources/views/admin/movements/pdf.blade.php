{{-- resources/views/admin/movements/pdf.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="metadata">
        ...
        <p><strong>Almacén:</strong> {{ $model->warehouse->name }}</p>
        <p><strong>Motivo:</strong> {{ $model->reason->name }}</p>
