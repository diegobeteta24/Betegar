{{-- resources/views/admin/transfers/pdf.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="metadata">
        ...
        <p><strong>Tipo:</strong> {{ $model->type == 1 ? 'Ingreso' : 'Egreso' }}</p>
        <p><strong>Almacén de origen: </strong> {{ $model->originWarehouse->name }}</p>
        <p><strong>Almacén de destino: </strong> {{ $model->destinationWarehouse->name }}</p>
