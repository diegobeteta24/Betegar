...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Conexión a la base LEGACY (dump antiguo) para migrar datos sin tocar estructura actual
        'legacy' => [
            'driver' => 'mysql',
            'host' => env('LEGACY_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('LEGACY_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('LEGACY_DB_DATABASE', 'legacy_dump'),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('LEGACY_MYSQL_ATTR_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
